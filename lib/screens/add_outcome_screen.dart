...
class AddOutcomeScreen extends StatefulWidget {
  const AddOutcomeScreen({Key? key});

  @override
  _AddOutcomeScreenState createState() => _AddOutcomeScreenState();
}
...
class _AddOutcomeScreenState extends State<AddOutcomeScreen> {
  ...
  void _saveData() async {
    ...
    if (result != -1) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Terjadi kesalahan. Pengeluaran gagal disimpan.'),
        ),
      );
    }
  }
      ...
      appBar: AppBar(
        title: Text(
          ...
          style: TextStyle(
            ...
            color: Color.fromARGB(255, 199, 97, 97),
          ),
        ),
      ),
